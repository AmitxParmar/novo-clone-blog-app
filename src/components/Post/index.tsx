    ...
    return (
        <div>
            <div className='w-full'>
                <div className='h-auto ease-in-out transition-none '>
                    {/* Card */}
                    <div className='relative flex flex-col min-w-0 break-words hover:bg-cyan/10 bg-white bg-clip-border border-[#e0e0e0] border-solid rounded-xl border-0 mb-2 text-sm '>
                        {/* Card Body */}
                        <div className='py-6 xl:p-8 min-h-[1px] flex-[1_1_auto] break-words '>
                            ...
                            <div
                                className='z-[1] relative lg:block xl:block break-words text-sm antialiased leading-normal before:z-[2] before:content-[""] before:w-full before:max-h-[30%] before:absolute before:left-0 before:bottom-0 bg-[linear-gradient(180deg,hsla(0,0%,100%,0),#fff)]'
                            >
                                <div className='max-h-64 overflow-hidden h-full text-ellipsis relative break-words text-sm leading-normal font-normal '>
