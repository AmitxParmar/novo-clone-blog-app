...
const CTA = () => {
  return (
    <div className="relative block flex-shrink-0 justify-end px-4 sm:max-w-1/2 overflow-clip scrollbar sm:flex-1/2 md:max-w-1/4 md:flex-1/2 lg:max-w-[33.33%] lg:flex-[0_0_33.33%] xl:flex-1/4">
